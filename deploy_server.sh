...
docker build -t gcr.io/rmit-doughnuts/b ./restful-web-services
kubectl apply -f ./restful-web-services/backend.yml
kubectl apply -f ./restful-web-services/service.yml
